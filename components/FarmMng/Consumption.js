            ...
            <SafeAreaView>
                ...
                >
                    <ScrollView showsVerticalScrollIndicator={false} >
                        <Text style={{ fontSize: 30, fontWeight: 'bold', padding: 20 }}>Consumption </Text>
                        <View style={{ flex: 1, alignItems: "center" }}>

                            <View style={{ width: "100%", paddingHorizontal: 30 }}>
                                <View>
                                    <Text style={{ fontSize: 18 }}>Dosage Date</Text>
                                    <TouchableOpacity
                                    ...
                                    >
                                        <Text style={{ fontSize: 17 }} onChangeText={(text) => setNewItem({ ...newItem, dosagedate: text })}  >{selectedStartDate}</Text>
                                    </TouchableOpacity>
                                </View>

                                <View>
                                    <Text style={{ fontSize: 18, marginTop: 14 }}>Select Product</Text>
                                    <TouchableOpacity
                                        style={styles.inputBtn}
                                    ...
                                    >
                                        <TextInput style={{ fontSize: 17 }} placeholder="Best TM" onChangeText={(text) => setNewItem({ ...newItem, selectproduct: text })}  ></TextInput>
                                    </TouchableOpacity>
                                </View>
                                ...
                                <View>
                                    <Text style={{ fontSize: 18, marginTop: 14 }}>Unit</Text>
                                    <TouchableOpacity
                                        style={styles.inputBtn}
                                    ...
                                    >
                                        <TextInput style={{ fontSize: 17 }} placeholder="(tonnes)" onChangeText={(text) => setNewItem({ ...newItem, unit: text })}  ></TextInput>
                                    </TouchableOpacity>
                                </View>
