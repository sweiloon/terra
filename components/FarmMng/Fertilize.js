            ...
            <SafeAreaView>
                ...
                >
                    <ScrollView showsVerticalScrollIndicator={false} >
                        <Text style={{ fontSize: 30, fontWeight: 'bold', padding: 20 }}>Fertilize </Text>
                        <View style={{ flex: 1, alignItems: "center" }}>
                            ...
                            <View style={{ width: "100%", paddingHorizontal: 30 }}>
                                ...
                                <View>
                                    ...
                                    >
                                        <TextInput style={{ fontSize: 17 }} placeholder="(tonnes)" onChangeText={(text) => setNewItem({ ...newItem, quatity: text })}  ></TextInput>
                                    </TouchableOpacity>
                                </View>
