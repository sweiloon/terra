            ...
            <SafeAreaView>
                ...
                >
                    <ScrollView showsVerticalScrollIndicator={false} >
                        <Text style={{ fontSize: 30, fontWeight: 'bold', padding: 20 }}>Harvest </Text>
                        <View style={{ flex: 1, alignItems: "center" }}>
                            ...
                            <View style={{ width: "100%", paddingHorizontal: 30 }}>
                                ...
                                <View>
                                    <Text style={{ fontSize: 18, marginTop: 14 }}>Quality</Text>
                                    <TouchableOpacity
                                        style={styles.inputBtn}
                                    ...
                                    >
                                        <TextInput style={{ fontSize: 17 }} placeholder="Grade A/B" onChangeText={(text) => setNewItem({ ...newItem, quality: text })} ></TextInput>
                                    </TouchableOpacity>
                                </View>
