    ...
    function renderHeader() {
        return (
            <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                <Text></Text>
                <Text style={{ ...FONTS.h2, marginTop: 15, marginLeft: 32 }} >Create New Zone</Text>
            </View>
        )
    }
    ...
    function renderSettings() {
        return (
            ...
            >
                ...
                <View>
                    <Text style={{ fontSize: 18, marginTop: 14 }}>Zone Name</Text>
                    <TouchableOpacity
                    ...
                    >
                        <TextInput style={{ fontSize: 17 }} placeholder="Zone1" onChangeText={(text) => setNewItem({ ...newItem, zonename: text })}   ></TextInput>
                    </TouchableOpacity>
                </View>
                ...
                <View>
                    <Text style={{ fontSize: 18, marginTop: 14 }}>Zone size</Text>
                    <TouchableOpacity
                        style={styles.inputBtn}
                    ...
                    >
                        <TextInput style={{ fontSize: 17 }} placeholder="arc" onChangeText={(text) => setNewItem({ ...newItem, zonesize: text })}  ></TextInput>
                    </TouchableOpacity>
                </View>


                <TouchableOpacity activeOpacity={0.8} style={styles.logoutbutton} onPress={() => console.log('Press')}>
                    <Text style={{ fontWeight: 'bold', fontSize: 20, color: 'white' }}>Add Zone</Text>
                </TouchableOpacity>
